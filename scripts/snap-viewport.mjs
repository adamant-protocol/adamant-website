...
const OUT = process.argv[2] || '/tmp/snaps/vp';
...
for (const P of PAGES) {
  try { await page.goto(BASE + P.path, { waitUntil: 'networkidle', timeout: 20000 }); } catch (e) {}
  await page.waitForTimeout(W < 700 ? 1200 : 2500);
